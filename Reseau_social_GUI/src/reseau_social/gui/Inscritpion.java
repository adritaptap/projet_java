...
public class Inscritpion extends javax.swing.JFrame {
    ...
    private void validateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validateActionPerformed
        ...
        if (userType.getSelectedItem() == "Directeur" ){
            ...
            message1 = "Vous êtes Inscrit";
            message2 = "Bienvenu sur loopr " + user.getName() + " " + user.getLastname();
            
            
        } else if (userType.getSelectedItem() == "Moderateur") {
            
            if (niv1.isSelected()){
                User user = new Moderateur_1(nameInput.getText(), lastnameInput.getText(), year);
                 UserList.setUserList(user);
                 message1 = "Vous êtes Inscrit";
                 message2 = "Bienvenu sur loopr " + user.getName() + " " + user.getLastname();
            } else {
               User user = new Moderateur_2(nameInput.getText(), lastnameInput.getText(), year);
               UserList.setUserList(user);
               message1 = "ous êtes Inscrit";
               message2 = "Bienvenu sur loopr " + user.getName() + " " + user.getLastname();              
            }
        } else {
            User user = new User(nameInput.getText(), lastnameInput.getText(), year);
            UserList.setUserList(user);
            message1 = "Vous êtes Inscrit";
            message2 = "Bienvenu sur loopr " + user.getName() + " " + user.getLastname();        
        }
